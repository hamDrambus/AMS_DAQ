...
private:
  ...
  using EventDataType = caen_output_data<uint16_t>;
  ...
  private:
    ...
    const FileFormat m_file_format;
  };
  ...
  void flusher_text(uint64_t chid, PayloadQueue &pq, size_t max_buffer_size, FileGenerator fg) const;
